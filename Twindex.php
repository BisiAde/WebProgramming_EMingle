<?php
	...
	if ( $isLoggedIn ) { // logged in
		...
		if ( property_exists( $user, 'errors' ) ) { // errors, clear session so user has to re-authorize with our app
	    	...
	    	<br />
	    	<!-- <b>User Email:</b> <?php echo $user->description; ?> -->
	    	<hr />
	    	<br />
...
<!DOCTYPE html>
	...
	<body>
     ...
     <div class="col-md-3">
     <a href="Tw1.logout.php"><button type="button" class="btn btn-danger" style="width:150px; background-color:silver; margin-left:-10px;">LOG OUT</button></a>
     </div>
 </div>
